...
## 第19条 (不適切なコンテンツおよび悪質ユーザーに対するゼロトレランス方針)
① 当社は健全なサービス環境の構築のため、不適切なコンテンツおよび悪質ユーザーに対してゼロトレランス方針を適用します。

② 会員はサービス加入時に本約款に同意することにより、以下の事項を確認し遵守することを誓約します：

不適切なコンテンツ投稿時は即座にアカウント停止または永久追放される可能性があること
他の利用者に対するハラスメント、ヘイトスピーチ、脅迫等の行為を絶対に行わないこと
サービス運営妨害行為時は法的措置を受ける可能性があること

③ 当社は不適切なコンテンツや悪質ユーザーに対していかなる寛容も示さず、該当行為を発見次第即座に強力な制裁措置を取ります。

&nbsp;

## 第20条 (ユーザーブロック機能)
① 会員は他の会員からハラスメントや不適切な行為を受けた場合、該当ユーザーをブロックする機能を利用することができます。

② ユーザーブロック機能は以下のように作動します：

ブロックされたユーザーはブロックした会員に対してメッセージ、コメント、フォロー等一切の相互作用を行うことができません
ブロックした会員はブロックされたユーザーの投稿、コメント等を見ることができなくなります
ブロックは会員がいつでも解除することができます

③ 当社はユーザーブロック機能が円滑に作動できるよう技術的支援を提供します。

&nbsp;

## 第21条 (通報処理および24時間対応体制)
① 当社は不適切なコンテンツや悪質ユーザーに対する通報を24時間以内に処理する体制を運営します。

② 通報処理手順は以下の通りです：

通報受付即座に該当コンテンツおよびユーザーに対する検討着手
24時間以内に調査完了および措置決定
不適切と判断された場合は即座にコンテンツ削除および該当ユーザー制裁

③ 通報処理の結果、不適切なコンテンツと確認された場合：

該当コンテンツは即座に削除されます
コンテンツを投稿したユーザーはサービスから即座に制裁（アカウント停止または永久追放）されます
通報者に処理結果を通知します

④ 当社は通報処理の透明性と一貫性を保証するため明確なガイドラインを策定しこれを公開します。

⑤ 悪意的または虚偽の通報を繰り返すユーザーに対しても制裁措置を取ることができます。
