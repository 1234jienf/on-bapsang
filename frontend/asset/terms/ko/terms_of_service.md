...
## 제19조 (부적절한 콘텐츠 및 악성 사용자에 대한 무관용 원칙)
① 회사는 건전한 서비스 환경 조성을 위해 부적절한 콘텐츠 및 악성 사용자에 대해 무관용 원칙을 적용합니다.

② 회원은 서비스 가입 시 본 약관에 동의함으로써 다음 사항을 확인하고 준수할 것을 서약합니다:

부적절한 콘텐츠 게시 시 즉시 계정 정지 또는 영구 차단될 수 있음
다른 이용자에 대한 괴롭힘, 혐오 발언, 위협 등의 행위를 절대 하지 않을 것
서비스 운영 방해 행위 시 법적 조치를 받을 수 있음

③ 회사는 부적절한 콘텐츠나 악성 사용자에 대한 어떠한 관용도 보이지 않으며, 해당 행위 발견 즉시 강력한 제재 조치를 취합니다.

&nbsp;

## 제20조 (사용자 차단 기능)
① 회원은 다른 회원으로부터 괴롭힘이나 부적절한 행위를 당했을 경우, 해당 사용자를 차단할 수 있는 기능을 이용할 수 있습니다.

② 사용자 차단 기능은 다음과 같이 작동됩니다:

차단된 사용자는 차단한 회원에게 메시지, 댓글, 팔로우 등 일체의 상호작용을 할 수 없습니다
차단한 회원은 차단된 사용자의 게시물, 댓글 등을 보지 않게 됩니다
차단은 회원이 언제든지 해제할 수 있습니다

③ 회사는 사용자 차단 기능이 원활히 작동할 수 있도록 기술적 지원을 제공합니다.

&nbsp;

## 제21조 (신고 처리 및 24시간 대응 체계)
① 회사는 부적절한 콘텐츠나 악성 사용자에 대한 신고를 24시간 내에 처리하는 체계를 운영합니다.

② 신고 처리 절차는 다음과 같습니다:

신고 접수 즉시 해당 콘텐츠 및 사용자에 대한 검토 착수
24시간 이내 조사 완료 및 조치 결정
부적절한 것으로 판단될 경우 즉시 콘텐츠 삭제 및 해당 사용자 제재

③ 신고 처리 결과 부적절한 콘텐츠로 확인된 경우:

해당 콘텐츠는 즉시 삭제됩니다
콘텐츠를 게시한 사용자는 서비스에서 즉시 제재(계정 정지 또는 영구 차단)됩니다
신고자에게 처리 결과를 통지합니다

④ 회사는 신고 처리의 투명성과 일관성을 보장하기 위해 명확한 가이드라인을 수립하고 이를 공개합니다.

⑤ 악의적이거나 허위 신고를 반복하는 사용자에 대해서도 제재 조치를 취할 수 있습니다.
