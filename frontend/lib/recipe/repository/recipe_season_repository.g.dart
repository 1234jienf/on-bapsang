...
part of 'recipe_season_repository.dart';
...
class _RecipeSeasonRepository implements RecipeSeasonRepository {
  _RecipeSeasonRepository(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<List<RecipeSeasonIngredientModel>> getSeasonIngredients(
    ...
    final _options = _setStreamType<List<RecipeSeasonIngredientModel>>(
