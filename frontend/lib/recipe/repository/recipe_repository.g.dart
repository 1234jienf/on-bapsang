...
class _RecipeRepository implements RecipeRepository {
  _RecipeRepository(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<RecipeDetailModel> getRecipeDetail(int id) async {
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<RecipeDetailModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/foreign/${id}',
    ...
    late RecipeDetailModel _value;
    try {
      _value = RecipeDetailModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<void> recipeScrap(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'accessToken': 'true'};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<void> cancelRecipeScrap(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'accessToken': 'true'};
    _headers.removeWhere((k, v) => v == null);
  ...
  Future<CursorSimplePagination<RecipeModel>> paginate({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CursorSimplePagination<RecipeModel> _value;
    try {
      _value = CursorSimplePagination<RecipeModel>.fromJson(
        _result.data!,
