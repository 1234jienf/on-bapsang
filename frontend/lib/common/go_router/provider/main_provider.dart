...
import '../../../signup/view/sign_up_terms_of_service.dart';
              ...
              routes: [
                GoRoute(
                  ...
                  builder: (_, state) {
                    ...
                    return SignUpTermsOfService(number: number);
                  },
                ),
              ],
            ),
        ...
        ShellRoute(
          ...
          routes: [
            GoRoute(
              ...
              name: 'home',
              pageBuilder:
                  (_, state) => const NoTransitionPage(child: HomePageScreen()),
              routes: [
                GoRoute(
                  path: 'menu',
                  name: 'HomeMenuScreen',
                ...
                GoRoute(
                  ...
                  pageBuilder:
                      (_, state) =>
                  const NoTransitionPage(child: RecipeRootScreen()),
                  routes: [
                    GoRoute(
                      path: 'season',
                ...
                GoRoute(
                  ...
                  pageBuilder:
                      (_, state) =>
                  const NoTransitionPage(child: CommunityRootScreen()),
                ),
                GoRoute(
                  path: 'maps',
                  name: 'maps',
                  pageBuilder:
                      (_, state) =>
                  const NoTransitionPage(child: MapsRootScreen()),
                  routes: [
                    GoRoute(
                      path: 'location',
                      name: 'location',
                      builder: (_, state) {
                        final locationData = state.extra as Map<String,
                            dynamic>?;
