...
part of 'mypage_recipe_repository.dart';
...
class _MypageRecipeRepository implements MypageRecipeRepository {
  _MypageRecipeRepository(this._dio, {this.baseUrl, this.errorLogger});
