...
class MapsPlaceFromCoordinatesModel {
  PlusCode? plusCode;
  List<Results>? results;
  String? status;

  MapsPlaceFromCoordinatesModel({this.plusCode, this.results, this.status});

  MapsPlaceFromCoordinatesModel.fromJson(Map<String, dynamic> json) {
...
class Results {
  ...
  Results.fromJson(Map<String, dynamic> json) {
    ...
    plusCode = json['plus_code'] != null
        ? new PlusCode.fromJson(json['plus_code'])
        : null;
    // 🔥 여기가 문제였던 부분 - null 체크 추가
    postcodeLocalities = (json['postcode_localities'] as List?)?.cast<String>() ?? [];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['postcode_localities'] = this.postcodeLocalities;
    return data;
  }
}
