...
class MapsGetCoordinatesFromPlaceIdModel {
  List<Null>? htmlAttributions;
  Result? result;
  String? status;

  MapsGetCoordinatesFromPlaceIdModel({this.htmlAttributions, this.result, this.status});

  MapsGetCoordinatesFromPlaceIdModel.fromJson(Map<String, dynamic> json) {
