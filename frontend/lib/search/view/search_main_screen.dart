...
class _ConsumerSearchMainScreenState extends ConsumerState<SearchMainScreen> {
  ...
  Padding _recommandSearch({required List<
      String> items, required BuildContext context, required WidgetRef ref}) {
    return Padding(
            ...
            return Padding(
              ...
              child: ConstrainedBox(
                constraints: BoxConstraints(minWidth: MediaQuery
                    .of(context)
                    .size
                    .width / 4 - 20, maxWidth: MediaQuery
                    .of(context)
                    .size
                    .width / 4 - 20),
                child: GestureDetector(
                  onTap: () {
                    ref.read(searchKeywordRemainProvider.notifier).setKeyword(
                        items[index]);
                    context.pushNamed(
                        SearchRootScreen.routeName, extra: items[index]);
                  },
                  child: Container(
  ...
  Padding _famousSearch({required List<
      String> items, required WidgetRef ref, required BuildContext context}) {
    return Padding(
              ...
              children: [
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ref.read(searchKeywordRemainProvider.notifier).setKeyword(
                          items[leftIndex]);
                      context.pushNamed(
                          SearchRootScreen.routeName, extra: items[leftIndex]);
                    },
                    child: Text(
                ...
                Expanded(
                    child: rightIndex < items.length
                      ...
                      onTap: () {
                        ref
                            .read(searchKeywordRemainProvider.notifier)
                            .setKeyword(items[rightIndex]);
                        context.pushNamed(SearchRootScreen.routeName,
                            extra: items[rightIndex]);
                      },
                      child: Text(
  ...
  Padding _recentSearch({required List<
      String> items, required BuildContext context, required WidgetRef ref}) {
    return Padding(
